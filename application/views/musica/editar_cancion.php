        ...
        <div class="row mt-3">
            <div class="col-12">
                ...
                <div class="card" id="main_div">
                    <div class="card-body">
                        <h4 class="header-title">Editar Canción</h4>
                        ...
                        <form id="form_edit" data-parsley-validate class="mt-3">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" name="artista" id="artista" required placeholder="Ingrese el artista de la cancion" class="form-control"
                                           data-parsley-trigger="change" data-parsley-error-message="El campo es requerido" value="<?=$row->artista?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    <div class="mt-3">
                                        ...
                                        <input type="file" name="fileinput" class="dropify" accept="audio/*" data-default-file="<?=base_url($row->ruta)?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group text-right m-b-0">
                                ...
                                <input type="hidden" value="<?=$row->id_cancion?>" name="id_cancion">
