...
<html lang="es">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <span><img src="<?=base_url();?>assets/digital.png" alt="" height="200"></span>
        ...
        <footer class="footer footer-alt">
            <?=date("Y")?> <a href="" class="text-white-50">API UES</a>
        </footer>
        ...
        <script src="<?=base_url();?>assets/admin/js/funciones/login.js"></script>
