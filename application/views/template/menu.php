    ...
    <div class="navbar-custom">
        ...
        <div class="logo-box">
            <a href="<?=base_url("dashboard")?>" class="logo text-center">
                ...
                <span class="logo-sm">
                    <img src="<?=base_url("assets/logo.png")?>" alt="" height="24">
                </span>
            </a>
        </div>
    ...
    <div class="left-side-menu">
        ...
        <div class="slimscroll-menu">
            ...
            <div class="user-box text-center">
                <img src="<?=base_url("assets/logo.png");?>" class="rounded-circle avatar-md">
                <div class="dropdown">
                    <a class="text-dark h5 mt-2 mb-1 d-block">Digital Templates</a>
                </div>
