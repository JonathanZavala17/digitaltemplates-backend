                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" name="nrc" id="nrc" class="form-control" value="<?=$row->nrc;?>">
                            </div>
                            <div class="form-group col-lg-4">
                                <label for="">Validar Codigo<span class="text-danger">*</span></label>
                                <select name="code_enabled" id="code_enabled" class="form-control select2" required="" parsley-trigger="change" data-parsley-error-message="El campo es requerido">
                                    <option value="1" <?php if($row->code_enabled){ echo "selected"; } ?>>Activado</option>
                                    <option value="0" <?php if(!$row->code_enabled){ echo "selected"; } ?>>Desactivado</option>
                                  </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mt-3">
                                    ...
                                    <input type="file" name="fileinput" class="dropify" data-default-file="<?=base_url($row->logo)?>"  />
