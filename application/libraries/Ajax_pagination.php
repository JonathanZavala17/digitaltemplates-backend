...
class Ajax_pagination{
    ...
    var $uri_segment	= 3;
    var $full_tag_open	= '<div class="blog-pagination"><nav aria-label="Page"><ul class="pagination">';
    ...
    function create_links(){
        ...
        if ($this->show_count){
            ...
            $info = 'Mostrando ' . ( $curr_offset + 1 ) . ' a ' ;
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<li class="page-item"><a class="page-link" href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.')">'. $text .'</a>';
    }
